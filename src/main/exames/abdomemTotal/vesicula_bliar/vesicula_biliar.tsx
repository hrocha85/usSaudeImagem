...
function VesiculaBiliar() {
    ...
    let calculoUnico = document.querySelector('#CalculoUnico') as HTMLInputElement
    let multiplosCalculos = document.querySelector('#MultiplosCalculos') as HTMLInputElement
    let polipoUnico = document.querySelector('#PolipoUnico') as HTMLInputElement
    let multiplosPolipos = document.querySelector('#MultiplosPolipos') as HTMLInputElement
    let colesterolose = document.querySelector('#colesterolose') as HTMLInputElement
    ...
    let billeEspessa = document.querySelector('#BilleEspessa') as HTMLInputElement
    let vazia = document.querySelector('#Vazia') as HTMLInputElement

    let InputMultiplosCalculos = document.querySelector('#InputMultiplosCalculos') as HTMLInputElement
    let InputCalculoUnico = document.querySelector('#InputCalculoUnico') as HTMLInputElement

    let InputPopiloUnico = document.querySelector('#InputPopiloUnico') as HTMLInputElement
    let InputMultiplosPolipos = document.querySelector('#InputMultiplosPolipos') as HTMLInputElement
    ...
    const [checkValueMultiplosCalculos, setCheckvalueMultiplosCalculos] = useState({
    ...
    const removeStringCalculo = () => {
        const index = laudoPrin.indexOf(inputCalculoUnico)
        if (index > -1) {
            laudoPrin.splice(index, 1)
            setLaudoPrin(arr => [...arr])
        }
    ...
    const removeStringPopilo = () => {
        const index = laudoPrin.indexOf(inputPoliposUnico)
        if (index > -1) {
            laudoPrin.splice(index, 1)
            setLaudoPrin(arr => [...arr])
        }
    ...
    const DeterminaCondicaoCheckNormal = () => {
        if (calculoUnico.checked === true ||
            multiplosCalculos.checked === true || polipoUnico.checked === true ||
            naoVisibilizado.checked === true || emPorcelana.checked === true ||
            billeEspessa.checked === true || vazia.checked === true ||
            multiplosPolipos.checked === true || colesterolose.checked === true) {
            setCheckvalueNormal({
                normal: true
            })
        } else {
        ...
        >
            ...
            >
                ...
                >
                    ...
                    <Box w='261px'>
                        ...
                        >Múltiplos cálculos, o maior mede:</Checkbox>
                        <Input
                            onBlur={(e) => { verificaChecked(e.target) }}
            ...
            >
                ...
                <Box w='256px'>
                    ...
                    >Múltiplos Pólipos, o maior mede:</Checkbox>
                    <Input
                        onBlur={(e) => { verificaChecked(e.target) }}
