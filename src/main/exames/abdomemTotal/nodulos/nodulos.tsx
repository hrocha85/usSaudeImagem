...
function Nodulos() {
    ...
    const criaStringNodulo01 = (value) => {
        ...
        const Frase = 'Nódulo 01 com' + valueInput01Nodulo01 + ' x ' + valueInput02Nodulo01 + 'mm localizado no '
            + valueSelect01Nodulo01 + ' do '
            + valueSelect02Nodulo01 + ' com contornos ' + valueSelect03Nodulo01 + ' do tipo ' + dadoSelect04Nodulo01
    ...
    const criaStringNodulo02 = (value) => {
        ...
        const Frase = 'Nódulo 01 com' + valueInput01Nodulo02 + ' x ' + valueInput02Nodulo02 + 'mm localizado no '
            + valueSelect01Nodulo02 + ' do '
            + valueSelect02Nodulo02 + ' com contornos ' + valueSelect03Nodulo02 + ' do tipo ' + dadoSelect04Nodulo02
        setLaudoPrin(arr => [...arr, Frase])
