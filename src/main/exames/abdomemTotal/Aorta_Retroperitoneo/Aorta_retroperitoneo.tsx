...
function Aorta_Retroperitoneo({ Disable }) {
    const altura = "100%";
    const largura = "66%";
    ...
    return (
        ...
        >
            ...
            <RadioGroup isDisabled={Disable} w='auto' onChange={setValue} value={value} padding="10px">
                <Stack direction="column">
                    ...
                    <Box w='auto'>
                        ...
                        <Box display='flex' flexWrap='wrap' marginTop="10px">
                            ...
                            />
                            <Text alignSelf='center'>mm e</Text>
                            <Input w='60px'
                                value={valueInput2}
                                placeholder="00"
                                isDisabled={!enableSelects}
                            ...
                            />
                            <Text alignSelf='center'>mm de extensão</Text>
                            <Checkbox
                                isDisabled={!enableSelects}
...
export default Aorta_Retroperitoneo