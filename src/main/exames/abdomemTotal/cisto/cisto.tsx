...
function Cisto() {
  ...
  const criaValorCisto01 = (value) => {
    ...
    const frase =
      ...
      " do " +
      dadoSelect2Cisto01;
    setFrasesCisto((arr) => [...arr, frase]);
    setFraseCisto01(frase);
  };

  const removeStringCisto01 = () => {
    const index = frasesCisto.indexOf(fraseCisto01);
    if (index > -1) {
  ...
  const removeStringCisto02 = () => {
    const index = frasesCisto.indexOf(fraseCisto02);
    if (index > -1) {
      frasesCisto.splice(index, 1);
      setFrasesCisto((arr) => [...arr]);
    }
  ...
  const removeStringCisto03 = () => {
    const index = frasesCisto.indexOf(fraseCisto03);
    if (index > -1) {
      frasesCisto.splice(index, 1);
      setFrasesCisto((arr) => [...arr]);
    }
  ...
  const removeStringCisto04 = () => {
    const index = frasesCisto.indexOf(fraseCisto04);
    if (index > -1) {
      frasesCisto.splice(index, 1);
      setFrasesCisto((arr) => [...arr]);
    }
  ...
  const criaValorMultiplosDireito = (value) => {
    ...
    const frase =
      "Multiplos Cistos no rim direito com " +
  ...
  const removeStringMultiplosDireito = () => {
    const index = frasesCisto.indexOf(fraseMultiplosDireito);
    if (index > -1) {
      frasesCisto.splice(index, 1);
      setFrasesCisto((arr) => [...arr]);
    }
  ...
  const criaValorMultiplosEsquerdo = (value) => {
    ...
    const frase =
      "Multiplos Cistos no rim esquerdo com " +
  ...
  const removeStringMultiplosEsquerdo = () => {
    const index = frasesCisto.indexOf(fraseMultiplosEsquerdo);
    if (index > -1) {
      frasesCisto.splice(index, 1);
      setFrasesCisto((arr) => [...arr]);
    }
  ...
  const criarString = (value, valueId?, valueInput?) => {
    ...
    setFrasesCisto((arr) => [...arr, value]);
    //console.log("criaString = ", laudoPrin)
  };

  const removeItemString = (value) => {
    // console.log("valor remove = ", value);
    var index = frasesCisto.indexOf(value);
