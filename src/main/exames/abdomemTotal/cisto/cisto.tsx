...
function Cisto() {
    ...
    const criaValorMultiplosDireito = (value) => {
        ...
        const frase = 'Multiplos Cistos no rim direito com ' +
    ...
    const criaValorMultiplosEsquerdo = (value) => {
        ...
        const frase = 'Multiplos Cistos no rim esquerdo com ' +
        ...
        >
            ...
            >
                <Box w='400px' >
                    ...
                    >Múltiplos cistos no rim direito, o maior mede</Checkbox>
                    <Input
                        onBlur={(e) => { verificaChecked(e.target) }}
                ...
                <Box w='400px' >
                    ...
                    >Múltiplos cistos no rim esquerdo, o maior mede</Checkbox>
                    <Input
                        onBlur={(e) => { verificaChecked(e.target) }}
