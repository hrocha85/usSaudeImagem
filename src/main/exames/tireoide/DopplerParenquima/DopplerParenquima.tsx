...
function DopplerParenquima() {
  ...
  const [
    VelSistolicaSuperioreriorDirCheckbox,
    setVelSistolicaSuperioreriorDirCheckbox,
  ] = useState(false);
  const [VelSistolicaSuperiorDirInput, setVelSistolicaSuperiorDirInput] =
    useState("");
  const [
    DisableVelSistolicaSuperiorDirInput,
    setDisableVelSistolicaSuperiorDirInput,
  ] = useState(true);
  ...
  const [DisableIRSuperiorDirInput, setDisableIRSuperiorDirInput] =
    useState(true);

  const [VelSistolicaInferiorDirCheckbox, setVelSistolicaInferiorDirCheckbox] =
    useState(false);
  const [VelSistolicaInferiorDirInput, setVelSistolicaInferiorDirInput] =
    useState("");
  const [
    DisableVelSistolicaInferiorDirInput,
    setDisableVelSistolicaInferiorDirInput,
  ] = useState(true);
  ...
  const [DisableIRInferiorDirInput, setDisableIRInferiorDirInput] =
    useState(true);

  const [
    VelSistolicaSuperioreriorEsqCheckbox,
    setVelSistolicaSuperioreriorEsqCheckbox,
  ] = useState(false);
  const [VelSistolicaSuperiorEsqInput, setVelSistolicaSuperiorEsqInput] =
    useState("");
  const [
    DisableVelSistolicaSuperiorEsqInput,
    setDisableVelSistolicaSuperiorEsqInput,
  ] = useState(true);
  ...
  const [DisableIRSuperiorEsqInput, setDisableIRSuperiorEsqInput] =
    useState(true);

  const [VelSistolicaInferiorEsqCheckbox, setVelSistolicaInferiorEsqCheckbox] =
    useState(false);
  const [VelSistolicaInferiorEsqInput, setVelSistolicaInferiorEsqInput] =
    useState("");
  const [
    DisableVelSistolicaInferiorEsqInput,
    setDisableVelSistolicaInferiorEsqInput,
  ] = useState(true);
  ...
  const [DisableIRInferiorEsqInput, setDisableIRInferiorEsqInput] =
    useState(true);
  ...
  useEffect(() => {
    ...
    VelSistolicaInferiorDirCheckbox,
    VelSistolicaInferiorDirInput,
    IRInferiorDirInput,
  ]);
  ...
  useEffect(() => {
    ...
    VelSistolicaInferiorEsqCheckbox,
    VelSistolicaInferiorEsqInput,
    IRInferiorEsqInput,
  ]);
  ...
  return (
    ...
    >
      ...
      >
        <Flex gap="30px">
          <Radio w="auto" value="1">
            Não citar
          </Radio>
          <Radio
            w="auto"
            value="As artérias tireoidianas apresentam curvas espectrais e velocidades sistólicas dentro da normalidade."
          >
            Doppler normal
          </Radio>
          <Radio
            w="auto"
            value="A avaliação do parênquima tireoidiano com Doppler demonstra sinais de hiperfluxo difuso."
          >
            Hiperfluxo difuso
          </Radio>
          ...
          >
            ...
            <HStack>
              <Checkbox
                isDisabled={!DisableDescreverDoppler}
                onChange={() =>
                  setIRSuperiorDirCheckbox(!IRSuperiorDirCheckbox)
                }
                ml="40px"
              >
                I.R.
          ...
          >
            ...
            <HStack>
              <Checkbox
                isDisabled={!DisableDescreverDoppler}
                onChange={() =>
                  setVelSistolicaInferiorDirCheckbox(
                    !VelSistolicaInferiorDirCheckbox
                  )
                }
              >
            ...
            <HStack>
              <Checkbox
                isDisabled={!DisableDescreverDoppler}
                onChange={() =>
                  setIRInferiorDirCheckbox(!IRInferiorDirCheckbox)
                }
                ml="40px"
              >
                I.R.
          ...
          >
            ...
            <HStack>
              <Checkbox
                isDisabled={!DisableDescreverDoppler}
                onChange={() =>
                  setIRSuperiorEsqCheckbox(!IRSuperiorEsqCheckbox)
                }
                ml="40px"
              >
                I.R.
          ...
          >
            ...
            <HStack>
              <Checkbox
                isDisabled={!DisableDescreverDoppler}
                onChange={() =>
                  setVelSistolicaInferiorEsqCheckbox(
                    !VelSistolicaInferiorEsqCheckbox
                  )
                }
              >
            ...
            <HStack>
              <Checkbox
                isDisabled={!DisableDescreverDoppler}
                onChange={() =>
                  setIRInferiorEsqCheckbox(!IRInferiorEsqCheckbox)
                }
                ml="40px"
              >
                I.R.
