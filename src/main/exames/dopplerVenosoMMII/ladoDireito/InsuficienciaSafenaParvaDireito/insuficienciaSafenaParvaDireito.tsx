...
function InsuficienciaSafenaParvaDireito() {
  const altura = "100%";
  const largura = "95%";
  ...
  const removeParcial = () => {
    frasesInsulSafenaParva.map((e) => {
      if (e.includes("Parcial")) {
        const index = frasesInsulSafenaParva.indexOf(e);
  ...
  const removeItemString = (value) => {
    const index = frasesInsulSafenaParva.indexOf(value);
  ...
  const subExame = "Insuficiência Safena Parva Direita";
...
export default InsuficienciaSafenaParvaDireito;
