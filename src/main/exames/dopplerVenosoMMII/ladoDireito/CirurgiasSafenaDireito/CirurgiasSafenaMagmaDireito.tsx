...
function CirurgiaSafenaMagmaDireito() {
  ...
  const criaStringAusenciaTotal = () => {
    var string = "Ausência total de cirurgias Safena Magna lado direito";
  ...
  return (
    ...
    <Box    >
      <Text
        fontSize="17px"
        fontWeight="bold">Safena Magna</Text>
      <Stack>
        <Checkbox
      ...
      <Checkbox
        ...
        onChange={() =>
          setAusenciaParcialCheckBox(!AusenciaParcialCheckBox)
        }
      >
        Ausencia Parcial
      </Checkbox>
