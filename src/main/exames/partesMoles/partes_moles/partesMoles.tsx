...
function Partes_Moles() {
  ...
  const [disableLipomaInputMultiplos, setDisableLipomaInputMultiplos] = useState(true)
  ...
  const [ecogenicidadeNoduloSelect, setEcogenicidadeNoduloSelect] = useState("");
  ...
  useEffect(() => {
    LocalNormalCheckbox ? setDisableInputLocalNormal(false) :
      setDisableInputLocalNormal(true); removeLocalNormal(); setInputLocalNormal('');
  }, [LocalNormalCheckbox])

  useEffect(() => {
    LocalLipomaCheckbox ? setDisableInputLocalLipoma(false) :
      setDisableInputLocalLipoma(true); removeLocalLipoma(); setInputLocalLipoma('');
  }, [LocalLipomaCheckbox])

  useEffect(() => {
    LocalNoduloCheckbox ? setDisableInputLocalNodulo(false) :
      setDisableInputLocalNodulo(true); removeLocalNodulo(); setInputLocalNodulo('');
    setEcogenicidadeNoduloSelect(''); setPlanoNoduloSelect(''); setMedida1Nodulo(''); setMedida2Nodulo(''); setMedida3Nodulo('')
  }, [LocalNoduloCheckbox])

  useEffect(() => {
    Lipoma1Checkbox ? setDisableLipomaInput1(false) :
      setDisableLipomaInput1(true); removeLipoma1(); setMedida1Lipoma1(''); setMedida2Lipoma1(''); setMedida3Lipoma1('')
  }, [Lipoma1Checkbox])

  useEffect(() => {
    Lipoma2Checkbox ? setDisableLipomaInput2(false) :
      setDisableLipomaInput2(true); removeLipoma2(); setMedida1Lipoma2(''); setMedida2Lipoma2(''); setMedida3Lipoma2('')
  }, [Lipoma2Checkbox])

  useEffect(() => {
    Lipoma3Checkbox ? setDisableLipomaInput3(false) :
      setDisableLipomaInput3(true); removeLipoma3(); setMedida1Lipoma3(''); setMedida2Lipoma3(''); setMedida3Lipoma3('')
  }, [Lipoma3Checkbox])

  useEffect(() => {
    Lipoma4Checkbox ? setDisableLipomaInput4(false) :
      setDisableLipomaInput4(true); removeLipoma4(); setMedida1Lipoma4(''); setMedida2Lipoma4(''); setMedida3Lipoma4('')
  }, [Lipoma4Checkbox])
  useEffect(() => {
    LipomaMultiplosCheckbox ? setDisableLipomaInputMultiplos(false) :
      setDisableLipomaInputMultiplos(true); removeMultiplosLipomas(); setMedida1LipomaMultiplos(''); setMedida2LipomaMultiplos(''); setMedida3LipomaMultiplos('')
  ...
  const criaStringLocalNodulo = (local, ecogenicidade, plano, medida1, medida2, medida3) => {
    removeLocalNodulo()
    if (local !== '') {
  ...
  const criaStringLipoma1 = (medida1Lipoma1, medida2Lipoma1, medida3Lipoma1) => {
    removeLipoma1()
    if (medida1Lipoma1 !== '' && medida2Lipoma1 !== '' && medida3Lipoma1 !== '') {
      let string = `Lipoma 1 mede ${medida1Lipoma1}x${medida2Lipoma1}x${medida3Lipoma1}mm`
      setLaudoPrin((arr) => [...arr, string])
    }
  }
  const criaStringLipoma2 = (medida1Lipoma2, medida2Lipoma2, medida3Lipoma2) => {
    removeLipoma2()
    if (medida1Lipoma2 !== '' && medida2Lipoma2 !== '' && medida3Lipoma2 !== '') {
      let string = `Lipoma 2 mede ${medida1Lipoma2}x${medida2Lipoma2}x${medida3Lipoma2}mm`
      setLaudoPrin((arr) => [...arr, string])
    }
  }
  const criaStringLipoma3 = (medida1Lipoma3, medida2Lipoma3, medida3Lipoma3) => {
    removeLipoma3()
    if (medida1Lipoma3 !== '' && medida2Lipoma3 !== '' && medida3Lipoma3 !== '') {
      let string = `Lipoma 3 mede ${medida1Lipoma3}x${medida2Lipoma3}x${medida3Lipoma3}mm`
      setLaudoPrin((arr) => [...arr, string])
    }
  }

  const criaStringLipoma4 = (medida1Lipoma4, medida2Lipoma4, medida3Lipoma4) => {
    removeLipoma4()
    if (medida1Lipoma4 !== '' && medida2Lipoma4 !== '' && medida3Lipoma4 !== '') {
      let string = `Lipoma 4 mede ${medida1Lipoma4}x${medida2Lipoma4}x${medida3Lipoma4}mm`
      setLaudoPrin((arr) => [...arr, string])
    }
  }
  const criaStringMultiplosLipomas = (medida1MultiplosLipomas, medida2MultiplosLipomas, medida3MultiplosLipomas) => {
    removeMultiplosLipomas()
    if (medida1MultiplosLipomas !== '' && medida2MultiplosLipomas !== '' && medida3MultiplosLipomas !== '') {
  ...
  useEffect(() => {
    criaStringMultiplosLipomas(medida1LipomaMultiplos, medida2LipomaMultiplos, medida3LipomaMultiplos)
  ...
  useEffect(() => {
    criaStringLocalNodulo(inputLocalNodulo, ecogenicidadeNoduloSelect, planoNoduloSelect, medida1Nodulo, medida2Nodulo, medida3Nodulo)
  }, [inputLocalNodulo, ecogenicidadeNoduloSelect, planoNoduloSelect, medida1Nodulo, medida2Nodulo, medida3Nodulo])
    ...
    >
      ...
      <Box gap="15px" display="flex" flexWrap="wrap">
        <Box
          ...
          w="100%">
          <HStack mb='10px'>
            <Checkbox onChange={(e) => setCheckboxLocalNormal(!LocalNormalCheckbox)}
              mr='30px'
            >Normal</Checkbox>
            <Text>Local</Text>
            <Input
              ...
              padding="5px"
              textAlign="center"
              onChange={(e) => { setInputLocalNormal(e.target.value) }}
            />
          </HStack>
        </Box>
        ...
        <Stack
          ...
          w='100%'>
          <HStack >
            <Checkbox onChange={(e) => setCheckboxLocalLipoma(!LocalLipomaCheckbox)}
              mr='30px'
            >Lipoma</Checkbox>
            <Text>Local</Text>
            <Input
              ...
              padding="5px"
              textAlign="center"
              onChange={(e) => { setInputLocalLipoma(e.target.value) }}
            />
          </HStack>
          ...
          <HStack>
            ...
            <Input
              ...
              maxLength={2}
              textAlign="center"
              onChange={(e) => { setMedida1Lipoma1(e.target.value) }}
            />
            <Text>x</Text>
            <Input
              isDisabled={disableLipomaInput1}
              ...
              maxLength={2}
              textAlign="center"
              onChange={(e) => { setMedida2Lipoma1(e.target.value) }}
            />
            <Text>x</Text>
            <Input
              isDisabled={disableLipomaInput1}
              ...
              maxLength={2}
              textAlign="center"
              onChange={(e) => { setMedida3Lipoma1(e.target.value) }}
            />
            <Text>mm</Text>
          </HStack>
          ...
          <HStack>
            ...
            <Input
              ...
              maxLength={2}
              textAlign="center"
              onChange={(e) => { setMedida1Lipoma2(e.target.value) }}
            />
            <Text>x</Text>
            <Input
              isDisabled={disableLipomaInput2}
              ...
              maxLength={2}
              textAlign="center"
              onChange={(e) => { setMedida2Lipoma2(e.target.value) }}
            />
            <Text>x</Text>
            <Input
              isDisabled={disableLipomaInput2}
              ...
              maxLength={2}
              textAlign="center"
              onChange={(e) => { setMedida3Lipoma2(e.target.value) }}
            />
            <Text>mm</Text>
          </HStack>
          ...
          <HStack>
            ...
            <Input
              ...
              maxLength={2}
              textAlign="center"
              onChange={(e) => { setMedida1Lipoma3(e.target.value) }}
            />
            <Text>x</Text>
            <Input
              isDisabled={disableLipomaInput3}
              ...
              maxLength={2}
              textAlign="center"
              onChange={(e) => { setMedida2Lipoma3(e.target.value) }}
            />
            <Text>x</Text>
            <Input
              isDisabled={disableLipomaInput3}
              ...
              maxLength={2}
              textAlign="center"
              onChange={(e) => { setMedida3Lipoma3(e.target.value) }}
            />
            <Text>mm</Text>
          </HStack>
          ...
          <HStack>
            ...
            <Input
              ...
              maxLength={2}
              textAlign="center"
              onChange={(e) => { setMedida1Lipoma4(e.target.value) }}
            />
            <Text>x</Text>
            <Input
              isDisabled={disableLipomaInput4}
              ...
              maxLength={2}
              textAlign="center"
              onChange={(e) => { setMedida2Lipoma4(e.target.value) }}
            />
            <Text>x</Text>
            <Input
              isDisabled={disableLipomaInput4}
              ...
              maxLength={2}
              textAlign="center"
              onChange={(e) => { setMedida3Lipoma4(e.target.value) }}
            />
            <Text>mm</Text>
          </HStack>

          <HStack>
            <Checkbox onChange={(e) => setLipomaMultiplosCheckbox(!LipomaMultiplosCheckbox)}>
            ...
            <Input
              ...
              maxLength={2}
              textAlign="center"
              onChange={(e) => { setMedida1LipomaMultiplos(e.target.value) }}
            />
            <Text>x</Text>
            <Input
              isDisabled={disableLipomaInputMultiplos}
              ...
              maxLength={2}
              textAlign="center"
              onChange={(e) => { setMedida2LipomaMultiplos(e.target.value) }}
            />
            <Text>x</Text>
            <Input
              isDisabled={disableLipomaInputMultiplos}
              ...
              maxLength={2}
              textAlign="center"
              onChange={(e) => { setMedida3LipomaMultiplos(e.target.value) }}
            />
            <Text>mm</Text>
          </HStack>
        </Stack >
        ...
        <Stack
          w='100%'>
          <HStack >
            <Checkbox onChange={(e) => setCheckboxLocalNodulo(!LocalNoduloCheckbox)}
              mr='30px'
            >Nódulo</Checkbox>
            <Text>Local</Text>
            <Input
              ...
              padding="5px"
              textAlign="center"
              onChange={(e) => { setInputLocalNodulo(e.target.value) }}
            />
          ...
          >
            <Select
              ...
              onChange={(e) => { setEcogenicidadeNoduloSelect(e.target.value) }}
            >
            ...
            <Select
              ...
              onChange={(e) => { setPlanoNoduloSelect(e.target.value) }}
            >
            ...
            <Box
              ...
              <Input
                ...
                maxLength={2}
                textAlign="center"
                onChange={(e) => { setMedida3Nodulo(e.target.value) }}
              />
              <Text>mm</Text>
            </Box>
          </Box>
          <Checkbox onChange={(e) => criaStringCheckBoxLinfonodo(e.target)}
            mr='30px'
          >Sugestivo de linfonodo</Checkbox>
        </Stack>
      </Box >
