...
function HerniacaoEsquerdo({ Disable }) {
  ...
  const criaStringMedidasHernia = () => {
    ...
    removeMedidaHernia();
    if (medidaHernia !== "") {
      const string = `Herniação de conteúdo omental através do canal inguinal Esquerdo medindo ${medidaHernia} cm de espessura, observado à manobra de valsalva`;
  ...
  const criaStringMedidasHerniaIntestinal = () => {
    ...
    if (medidaHerniaIntestinal !== "") {
      const string = `Herniação de conteúdo omental e intestinal através do canal inguinal Esquerdo até a bolsa escrotal, com pouca mobilidade às manobras de compressão e Valsalva. 
