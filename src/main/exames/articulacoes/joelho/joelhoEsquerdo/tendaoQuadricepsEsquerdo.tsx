...
function TendaoQuadricepsEsquerdo() {
  const altura = "100%";
  const largura = "95%";
  ...
  const criaStringTendinite = () => {
    var string = "TendaoQuadriceps Esquerdo com Tendinite";
  ...
  const criaStringTendinose = () => {
    var string = "TendaoQuadriceps Esquerdo com Tendinose";
...
export default TendaoQuadricepsEsquerdo;
