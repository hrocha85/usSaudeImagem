...
function MeniscoLateralEsquerdo() {
  ...
  const criaStringProtrusao = (Protrusao) => {
    removeProtrusao();
    if (Protrusao !== "") {
      const string = `Menisco Lateral Esquerdo com Protrusao  ${Protrusao}. `;
  ...
  const criaStringRotura = (Rotura) => {
    removeRotura();
    if (Rotura !== "") {
      const string = `Menisco Lateral Esquerdo com Rotura  ${Rotura}. `;
      setLaudoPrin((arr) => [...arr, string]);
    }
  };
  ...
  const criaStringCisto = (medida1, medida2) => {
    removeCisto();
    if (medida1 !== "" && medida2 !== "") {
      const string = `Menisco Lateral Esquerdo com Cisto e intervalo de ${medida1}x${medida2} mm `;
      setLaudoPrin((arr) => [...arr, string]);
    }
  };
