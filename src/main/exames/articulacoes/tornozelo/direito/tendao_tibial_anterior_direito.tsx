...
export default function Tendao_Tibial_Anterior_Direito() {
  ...
  const subExame = "Tendão Tibial Anterior Direito";
      ...
      case "Aspecto Normal":
        {
          ...
          setFrasesTornozelo(
            !valueCheckBox
              ? (arr) => [...arr, "Com ecotextura e espessura preservadas e contornos normais."]
              : (arr) => [
                  ...arr,
      ...
      case "Tendinopatia sem rotura":
        {
          ...
          setMedida3Lesao("");
          if (valueSelect1 != "") {
            setFrasesTornozelo((arr) => [...arr, `Espessado, com alteração ecotextural, mas sem evidências de rotura, ${valueSelect1}`]);
          }
        }
        break;
