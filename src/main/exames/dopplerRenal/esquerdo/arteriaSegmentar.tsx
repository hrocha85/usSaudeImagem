...
function ArteriaSegmentarEsquerda() {
  const altura = "100%";
  const largura = "95%";
  ...
  const subExame = "Arteria Segmentar Esquerda";
  ...
  return (
    <Box
      ...
      mt="15px"
    >
      <TituloNomeExame titulo="Arteria Segmentar Esquerda" />
      <Checkbox onChange={() => setPVSSegmentarCheckBox(!PVSSegmentarCheckBox)}>
        PVS da artéria segmentar esq.
      </Checkbox>
...
export default ArteriaSegmentarEsquerda;
