...
import { Box, Checkbox, Input, Text, Select } from "@chakra-ui/react";
...
function Abscesso() {
    ...
    const [checkboxAbscessoPresente, setCheckboxAbscessoPresente] = useState(false)
    const [disableAbscessoPresente, setDisableAbscessoPresente] = useState(true)
    const [valueSelectDistanciaAbscessoPresente, setValueSelectDistanciaAbscessoPresente] = useState('')
    const [valueSelectLocalAbscessoPresente, setValueSelectLocalAbscessoPresente] = useState('')
    const [valueInputTamanhoAbscessoPresente, setValueInputTamanhoAbscessoPresente] = useState('')
    const [valueInputTamanho2AbscessoPresente, setValueInputTamanho2AbscessoPresente] = useState('')
    ...
    const criaStringAbscessoPresente = () => {
        ...
        if (checkboxAbscessoPresente) {
            ...
            if (valueSelectDistanciaAbscessoPresente !== '' && valueSelectLocalAbscessoPresente !== '' &&
                valueInputTamanhoAbscessoPresente !== '' && valueInputTamanho2AbscessoPresente !== '') {
        ...
        >
            <Box
                ...
                >
                    ...
                    >
                        <Checkbox
                            onChange={(e) => { setCheckboxAbscessoPresente(!checkboxAbscessoPresente) }}
                        >Presente
                        </Checkbox>
                        <Select
                            w='150px'
                            isDisabled={disableAbscessoPresente}
                            onChange={(e) => { setValueSelectDistanciaAbscessoPresente(e.target.value) }}
                        ...
                        <Select
                            w='150px'
                            isDisabled={disableAbscessoPresente}
                            onChange={(e) => { setValueSelectLocalAbscessoPresente(e.target.value) }}
                        ...
                        <Input
                            ...
                            maxLength={2}
                            textAlign="center"
                            onChange={(e) => { setValueInputTamanhoAbscessoPresente(e.target.value) }}
                            placeholder={"mm"}
                        />
                        ...
                        <Input
                            ...
                            maxLength={2}
                            textAlign="center"
                            onChange={(e) => { setValueInputTamanho2AbscessoPresente(e.target.value) }}
                            placeholder={"mm"}
                        />
                    </Box>
                </Box>
