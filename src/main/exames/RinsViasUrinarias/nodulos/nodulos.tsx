...
function Nodulos() {
    ...
    const criaStringNodulo01 = (Input01Nodulo01, Input02Nodulo01, Select01Nodulo01, Select02Nodulo01, Select03Nodulo01, Select04Nodulo01) => {
        removeStringNodulo01()
        if (Input01Nodulo01 !== '' &&
            Input02Nodulo01 !== '' && Select01Nodulo01 !== '' && Select02Nodulo01 !== '' && Select03Nodulo01 !== '' && Select04Nodulo01 !== '') {
    ...
    }, [valueInput01Nodulo01, valueInput02Nodulo01, valueSelect01Nodulo01, valueSelect02Nodulo01, valueSelect03Nodulo01, valueSelect04Nodulo01])
    ...
    const criaStringNodulo02 = (Input01Nodulo02, Input02Nodulo02, Select01Nodulo02, Select02Nodulo02, Select03Nodulo02, Select04Nodulo02) => {
        removeStringNodulo02()
        if (Input01Nodulo02 !== '' &&
            Input02Nodulo02 !== '' && Select01Nodulo02 !== '' && Select02Nodulo02 !== '' && Select03Nodulo02 !== '' && Select04Nodulo02 !== '') {
    ...
    }, [valueInput01Nodulo02, valueInput02Nodulo02, valueSelect01Nodulo02, valueSelect02Nodulo02, valueSelect03Nodulo02, valueSelect04Nodulo02])
        ...
        >
            < Box
                ...
                >
                    ...
                    <Box w='160px' >
                        <Checkbox
                            onChange={(e) => { setCheckboxNodulo01(!checkboxNodulo01) }}
                        >Nódulo 01</Checkbox>
                        <Box>
                            <Input
                                value={valueInput01Nodulo01}
                                onChange={(e) => { setValueInput01Nodulo01(e.target.value) }}
                            ...
                            <Input
                                ...
                                onChange={(e) => { setValueInput02Nodulo01(e.target.value) }}
                                isDisabled={disableNodulo01}
                                maxLength={3}
                                w='55px' placeholder='00' />
                            mm
                        ...
                        <Select
                            ...
                            onChange={(e) => { setValueSelect01Nodulo01(e.target.value) }}
                            mt='5px'
                            w='160px' >
                        ...
                        <Select
                            ...
                            onChange={(e) => { setValueSelect02Nodulo01(e.target.value) }}
                            mt='5px'
                            w='160px' >
                        ...
                        <Select
                            ...
                            onChange={(e) => { setValueSelect03Nodulo01(e.target.value) }}
                            mt='5px'
                            w='160px'>
                        ...
                        <Select
                            ...
                            onChange={(e) => { setValueSelect04Nodulo01(e.target.value) }}
                            mt='5px'
                            w='160px'>
                    ...
                    <Box w='160px' >
                        <Checkbox
                            onChange={(e) => { setCheckboxNodulo02(!checkboxNodulo02) }}
                        >Nódulo 02</Checkbox>
                        <Box>
                            <Input
                                value={valueInput01Nodulo02}
                                onChange={(e) => { setValueInput01Nodulo02(e.target.value) }}
                                isDisabled={disableNodulo02}
                                w='55px' placeholder='00' />
                            x
                            <Input
                                value={valueInput02Nodulo02}
                                onChange={(e) => { setValueInput02Nodulo02(e.target.value) }}
                                isDisabled={disableNodulo02}
                                w='55px' placeholder='00' />
                            mm
                        </Box>
                        <Select
                            ...
                            onChange={(e) => { setValueSelect01Nodulo02(e.target.value) }}
                            isDisabled={disableNodulo02}
                            mt='5px'
                            w='160px' >
                            <option value='' disabled selected>Localizado no</option>
                        ...
                        <Select
                            ...
                            onChange={(e) => { setValueSelect02Nodulo02(e.target.value) }}
                            isDisabled={disableNodulo02}
                            mt='5px'
                            w='160px' >
                            <option value='' disabled selected>Do</option>
                        ...
                        <Select
                            ...
                            onChange={(e) => { setValueSelect03Nodulo02(e.target.value) }}
                            isDisabled={disableNodulo02}
                            mt='5px'
                            w='160px'>
                            <option value='' disabled selected>Contornos</option>
                        ...
                        <Select
                            ...
                            onChange={(e) => { setValueSelect04Nodulo02(e.target.value) }}
                            isDisabled={disableNodulo02}
                            mt='5px'
                            w='160px'>
                            <option value='' disabled selected>Ecogenicidade</option>
