...
function Cisto() {
  ...
  let select2Cisto01 = document.querySelector(
    "#Select2Cisto01"
  ) as HTMLInputElement;
  ...
  let select2Cisto02 = document.querySelector(
    "#Select2Cisto02"
  ) as HTMLInputElement;
  ...
  let select2Cisto03 = document.querySelector(
    "#Select2Cisto03"
  ) as HTMLInputElement;

  let inputCisto04 = document.querySelector(
    "#InputCisto04"
  ) as HTMLInputElement;
  let selectCisto04 = document.querySelector(
    "#SelectCisto04"
  ) as HTMLInputElement;
  let select2Cisto04 = document.querySelector(
    "#Select2Cisto04"
  ) as HTMLInputElement;
  ...
  const criaValorCisto01 = (value) => {
    ...
    const frase =
      ...
      " do " +
      dadoSelect2Cisto01;
    setFrasesCistos((arr) => [...arr, frase]);
    setFraseCisto01(frase);
  };

  const removeStringCisto01 = () => {
    const index = frasesCistos.indexOf(fraseCisto01);
    if (index > -1) {
  ...
  const removeStringCisto02 = () => {
    const index = frasesCistos.indexOf(fraseCisto02);
    if (index > -1) {
      frasesCistos.splice(index, 1);
      setFrasesCistos((arr) => [...arr]);
    }
  ...
  const removeStringCisto03 = () => {
    const index = frasesCistos.indexOf(fraseCisto03);
    if (index > -1) {
      frasesCistos.splice(index, 1);
      setFrasesCistos((arr) => [...arr]);
    }
  ...
  const removeStringCisto04 = () => {
    const index = frasesCistos.indexOf(fraseCisto04);
    if (index > -1) {
      frasesCistos.splice(index, 1);
      setFrasesCistos((arr) => [...arr]);
    }
  ...
  const criaValorMultiplosDireito = (value) => {
    ...
    const frase =
      "Multiplos Cistos no LOBO DIREITO com " +
      valueInputMultiplosDireito +
      " mm Localizado no " +
      dadoSelect2MultiplosDireito;
    setFrasesCistos((arr) => [...arr, frase]);
    setFraseMultiplosDireito(frase);
  };

  const removeStringMultiplosDireito = () => {
    const index = frasesCistos.indexOf(fraseMultiplosDireito);
    if (index > -1) {
      frasesCistos.splice(index, 1);
      setFrasesCistos((arr) => [...arr]);
    }
  ...
  const criaValorMultiplosEsquerdo = (value) => {
    ...
    const frase =
      "Multiplos Cistos no LOBO ESQUERDO com " +
      valueInputMultiplosEsquerdo +
      " mm Localizado no " +
      dadoSelect2MultiplosEsquerdo;
    setFrasesCistos((arr) => [...arr, frase]);
    setFraseMultiplosEsquerdo(frase);
  };

  const removeStringMultiplosEsquerdo = () => {
    const index = frasesCistos.indexOf(fraseMultiplosEsquerdo);
    if (index > -1) {
      frasesCistos.splice(index, 1);
      setFrasesCistos((arr) => [...arr]);
    }
  ...
  const criarString = (value, valueId?, valueInput?) => {
    ...
    setFrasesCistos((arr) => [...arr, value]);
    //console.log("criaString = ", laudoPrin)
  };

  const removeItemString = (value) => {
    // console.log("valor remove = ", value);
    var index = frasesCistos.indexOf(value);
    ...
    >
      ...
      <Box gap="25px" display="flex" flexWrap="wrap" mb="10px">
        <Box w="400px">
          ...
          >
            Múltiplos cistos no LOBO DIREITO, o maior mede
          </Checkbox>
          <Input
            onBlur={(e) => {
              verificaChecked(e.target);
        ...
        <Box w="400px">
          ...
          >
            Múltiplos cistos no LOBO ESQUERDO, o maior mede
          </Checkbox>
          <Input
            onBlur={(e) => {
              verificaChecked(e.target);
